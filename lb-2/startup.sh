...
TCP_CLIENT="node --env-file=.env tcp-client.js"
UDP_CLIENT="node --env-file=.env udp-client.js"
...
gnome-terminal -- bash -c "$TCP_CLIENT; exec bash"
gnome-terminal -- bash -c "$UDP_CLIENT; exec bash"
